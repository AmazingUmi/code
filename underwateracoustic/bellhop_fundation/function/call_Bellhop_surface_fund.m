function call_Bellhop_surface_fund(ETOPO,WOA18,envfil, freq, SD, timeIdx, latitude, longitude, R, azi, sourceRange, rmax, run_type, option_type, angle_bound)
model = 'BELLHOP';
